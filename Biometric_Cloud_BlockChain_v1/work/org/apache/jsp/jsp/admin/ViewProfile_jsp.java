...
while(rs.next())
{
      ...
      out.write("                     <h2 style=\"color:#337ab7\">View Profile</h2>   \r\n");
      out.write("                    </div>\r\n");
      out.write("                </div>              \r\n");
      out.write("                 <!-- /. ROW  -->\r\n");
      out.write("                  <hr />\r\n");
      ...
      out.write("    \t\t\t\t\t\t\t\t<td><input  type=\"text\" style=\"border-radius: 1px; width: 60%; padding-left: 5px;\" value=");
      ...
      out.write("    \t\t\t\t\t\t\t\t<td>\r\n");
      out.write("    \t\t\t\t\t\t\t\t<input id=\"n1\" type=\"text\"  style=\"border-radius: 1px; width: 60%; padding-left: 5px;\" value=");
