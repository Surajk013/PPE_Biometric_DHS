  									...
  									<tbody>
    									<tr>
      										...
      										<td><%=rs.getString(3)%></td>
      										 ...
      										 <td><a href="<%=request.getContextPath()%>/checkadharcardrequest?adharno=<%=rs.getString(2)%>"><input type="submit" value="Verify" name="Verify" style="border-radius: 3px; width: 80%; padding-left: 5px;"></a></td>
